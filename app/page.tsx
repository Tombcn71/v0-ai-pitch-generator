            ...
            <div className="flex flex-col md:flex-row gap-8 items-center">
              <div className="md:w-1/2 space-y-4">
                ...
                <p className="text-muted-foreground md:text-lg">
                  Learn at your own pace with Martina Guzman's comprehensive video course on pitch mastery. From
                  fundamentals to advanced techniques, this course covers everything you need to deliver compelling
                  pitches that win over any audience.
                </p>
                <ul className="space-y-2">
                  <li className="flex items-center">
                    <svg
              ...
              <div className="md:w-1/2 bg-card rounded-xl overflow-hidden border shadow-sm">
                <div className="aspect-video relative bg-muted flex items-center justify-center">
                  ...
                  <p className="absolute bottom-4 left-4 text-sm font-medium">Preview: Mastering Your Pitch Delivery</p>
                </div>
                <div className="p-4">
                  <h3 className="font-bold text-lg mb-2">The Complete Pitch Mastery Course</h3>
                  <div className="flex items-center justify-between">
                    <div className="flex items-center">
                      ...
                      <span className="text-sm">4.9/5 (over 120 reviews)</span>
                    </div>
